...
\includegraphics[height=.75in]{../../_Graphics/ConceptsTheory.png}

##Insight in science

\includegraphics[height=2in]{../../_Graphics/ScientificInference.png}
...
BE PREPRED FOR CONCRETE EXAMPLE!
...
Show that  $\Pr(A,B)=Pr(A)Pr(B)$ if $A$ and $B$ are indepdenent events.
