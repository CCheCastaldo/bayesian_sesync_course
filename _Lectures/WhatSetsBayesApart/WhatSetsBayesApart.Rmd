...
author: `r fileName="../../_HeadersEtc/SESYNCBayes/Authors.txt";readChar(fileName,file.info(fileName)$size)`
date: "June 2019"
output: 
  beamer_presentation:
    includes:
...
\center\includegraphics[width=0.4\paperwidth]{../../_Graphics/pValues.png}
...
\center\includegraphics[width=0.95\columnwidth]{../../_Graphics/BayesianModelingSteps.png}

## Learning outcomes

\center\includegraphics[width=0.35\columnwidth]{../../_Graphics/HobbsModelingProcess.pdf}
...
- Evaluate model fit.
- Appreciate possibilities for model selection.
...
I am going to do this on the board. The board notes for this are in the lecture folder.
