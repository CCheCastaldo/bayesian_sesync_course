...
pacman::p_load(shape, pBrackets, tikzDevice, knitr, rmarkdown)
...
Likelihood allows us to compare alternative parameter values and models by calculating the probability (or probability density) of the data conditional on the parameters $[\, y \mid \theta]$. As you will see, all evidence based on likelihood is relative.
