...
By calculating the $\sqrt{\sum_1^n\frac{1}{n}(y_i-\mu_i)^2}$
...
The $y_{i}$ are the cells in column B, $\mu_{i}$ are the predictions of the model for each light level in colum C, and $\sigma$ is one of the parameters to be estimated in cell I5.
...
The predictor variables are measured without error. We are interested in the light seen by the tree.  The x-values are imperfect approximation of to that unobserved qauntity.
