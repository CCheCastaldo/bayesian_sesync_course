...
The y<sub>i</sub> are the cells in column B, mu<sub>i</sub> are the predictions of the model for each light level in column C, and sigma is one of the parameters to be estimated in cell I5.
