...
4. $u_{ik}=$ true measure of soil water content in the $i_{th}$ plot in the $k_{th}$ stream reach

5. $z_{ik}=$ true proportion of herbaceous cover in the $i_{th}$ plot in the $k_{th}$ stream reach
