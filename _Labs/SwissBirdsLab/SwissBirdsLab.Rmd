...
$$\mu=\beta_0+ \beta_1x_1+\beta_2x_1^2.$$ 

To find the maximum, we take the first derivative $\frac {d\mu}{dx}=\beta_1+ 2\beta_1 x_{1}$, set it to zero $0=\beta_1+ 2\beta x_2$, and solve for $x_1$, $x_1=\frac{-\beta_1}{2\beta_2}$. You include this result as a derived quantity in your JAGS code.
