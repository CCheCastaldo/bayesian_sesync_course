...
Write out the joint and conditional distributions for the following Bayesian networks.
...
<div style="width:200px; height=200px; margin:0 auto;"><center> ![](../../_Graphics/MarginalDistribution.png)</center></div>
...
```{r eval = TRUE, echo = TRUE, include = TRUE, fig.width = 8, fig.height = 4, fig.align = 'center'}
par(mfrow= c(1, 2))
