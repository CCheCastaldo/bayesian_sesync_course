...
<button class="button" onclick="toggle_visibility('myDIV5B');">Answer</button>

<div id="myDIV5B", style="display:none">
...
<button class="button" onclick="toggle_visibility('myDIV5C');">Answer</button>

<div id="myDIV5C", style="display:none">
